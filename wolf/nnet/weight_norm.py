...
class CondConv2dWeightNorm(nn.Module):
    """
    Conv2d with weight normalization
    """

    def __init__(self, in_channels, out_channels, h_channels, kernel_size, stride=1,
                 padding=0, dilation=1, groups=1, bias=True):
        super(CondConv2dWeightNorm, self).__init__()
        self.conv = CondConv2d(in_channels, out_channels, h_channels, kernel_size, stride=stride,
