...
python -u distributed.py \
    --nproc_per_node 3 \
    --config  configs/cifar10/glow/glow-cat-uni-condconv.json \
    --epochs 15 --valid_epochs 10 \
    ...
    --data_path data/cifar_data --model_path models/glow/cifar_linear_condconv_model --dataset cifar10
